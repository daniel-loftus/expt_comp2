...
'''
This version of pileupToCounts adds the functionality of taking a bed file 
(including file types based on bed format such as broadPeak) and outputting the 
total allelic bias for each genomic feature in the bed file
'''
#%%
def pileupToCounts(pileupFile, snpFile, quantSNPs = False, quantFeatures = False, featuresBed = None, refAllele = 'mat', bedMinCount = 10, bedOutPrefix = 'out'):
    ...
    def quantFeaturesByChrom(countsDF, bpDF, minSNPs = 1, bedOut = False, bedPrefix = 'out'):
    ...
    if quantFeatures == True:
        ...
        bed.to_csv(f'{bedOutPrefix}_features.bedgraph')
